...
type: concept
name: "Striatal functional parcellation across development (Wave-1) + W4 validation"
...
description: |
  ...
  was NOT complete and used a DIFFERENT scanner/data — so the CLAD question is validating + applying the Wave-1
